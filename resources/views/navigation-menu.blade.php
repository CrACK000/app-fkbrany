<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img class="dark:hidden block" src="{{ asset('img/logo_light_black.svg') }}" width="60" alt="logo">
                        <img class="dark:block hidden" src="{{ asset('img/logo_white_notext.svg') }}" width="60" alt="logo">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('references') }}" :active="request()->routeIs('references')">
                        {{ __('Referencie') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('references') }}" :active="request()->routeIs('references')">
                {{ __('Referencie') }}
            </x-responsive-nav-link>
